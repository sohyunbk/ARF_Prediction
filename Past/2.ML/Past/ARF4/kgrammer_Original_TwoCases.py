...
###############################################################
###############################################################
def Running_ML(PeakLabel,PeakSeq,BorderLabel,BorderSeq,NonPeakLabel_Ori,NonPeakSeq_Ori,nNonPeak_New,nNonPeak_Ori,nBorder_Choice):

    NonPeakLabel,NonPeakSeq = SubSampling(nNonPeak_New,nNonPeak_Ori,NonPeakLabel_Ori,NonPeakSeq_Ori)
...
def Main(sBinSize):
    ...
    NonPeakLabel_Ori,NonPeakSeq_Ori = Bringfiles(DataPath+"ARF4_bin"+sBinSize+"_NonPeakRemoveR.fa")
    BorderLabel,BorderSeq = Bringfiles(DataPath+"ARF4_bin"+sBinSize+"_Border.fa")

    nPeak_Ori= len(PeakLabel)
    nNonPeak_Ori= len(NonPeakLabel_Ori)
    nBorder_Ori= len(BorderLabel)
    print("Peak: "+str(nPeak_Ori))
    print("Non Peak: "+str(nNonPeak_Ori))
    print("Border: "+str(nBorder_Ori))

    ## 1) No Border 
    print("No Border")
    nNonPeak_New = nPeak_Ori
    Running_ML(PeakLabel,PeakSeq,BorderLabel,BorderSeq,NonPeakLabel_Ori,NonPeakSeq_Ori,nNonPeak_New,nNonPeak_Ori,2)

    ## 2) peak
    print("Considered as Peak")
    nNonPeak_New = nPeak_Ori+nBorder_Ori
    #Running_ML(PeakLabel,PeakSeq,BorderLabel,BorderSeq,NonPeakLabel_Ori,NonPeakSeq_Ori,nNonPeak_New,nNonPeak_Ori,1)
