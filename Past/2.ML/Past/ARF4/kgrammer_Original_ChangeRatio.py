...
def Main(sBinSize,Ratio):
    ...
    if Ratio != "Original": 
        PeakLabel,PeakSeq = Bringfiles(DataPath+"ARF4_bin"+sBinSize+"_Peak.fa")
        NonPeakLabel,NonPeakSeq = Bringfiles(DataPath+"ARF4_bin125_NonPeak_Ratio1:"+str(Ratio)+".fa")
        BorderLabel,BorderSeq = Bringfiles(DataPath+"ARF4_bin125_Border_Ratio1:"+str(Ratio)+".fa")
    else :
        PeakLabel,PeakSeq = Bringfiles(DataPath+"ARF4_bin"+sBinSize+"_Peak.fa")
        NonPeakLabel,NonPeakSeq = Bringfiles(DataPath+"ARF4_bin125_NonPeak.fa")
    ...
    Running_ML(PeakLabel,PeakSeq,BorderLabel,BorderSeq,NonPeakLabel,NonPeakSeq,1)
    
    ## 3) Nonpeak
    print("Considered as NonPeak")
    Running_ML(PeakLabel,PeakSeq,BorderLabel,BorderSeq,NonPeakLabel,NonPeakSeq,0)

    
    ## 4) Border
    print("Considered as Border(Multiclass)")
    Running_ML(PeakLabel,PeakSeq,BorderLabel,BorderSeq,NonPeakLabel,NonPeakSeq,2)
