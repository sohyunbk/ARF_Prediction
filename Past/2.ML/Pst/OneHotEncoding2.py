...
if __name__ == "__main__": 
    PeakDic = ReadFastaFile("ARF4_bin125_Peak.fa")
    arr_matrix1 = one_hot_encode(PeakDic)
    NonPeakDic = ReadFastaFile("ARF4_bin125_NonPeak.fa")
    ...
    TFIDF_LR.fit(X_train_flattened, y_train)	
    LR_hold_TFIDF_pred = TFIDF_LR.predict(X_test_flattened)
    ...
    print(metrics.confusion_matrix(y_test, LR_hold_TFIDF_pred)) 
