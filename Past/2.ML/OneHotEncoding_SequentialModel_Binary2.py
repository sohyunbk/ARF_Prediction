...
def Main(nARF): 
    ...
    model.add(layers.conv_layer)
    model.add(layers.MaxPooling1D(pool_size=13,strides=2,padding='valid'))
    model.add(layers.conv_layer)
    #model.add(MaxPooling1D(pool_size=13,strides=2,padding='valid'))
    model.summary()
    model.add(Flatten())
