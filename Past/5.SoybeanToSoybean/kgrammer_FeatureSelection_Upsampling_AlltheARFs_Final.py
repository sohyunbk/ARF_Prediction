...
def Running_ML(PeakLabel,PeakSeq,BorderLabel,BorderSeq,NonPeakLabel,NonPeakSeq,nBorder_Choice):
   ...
   ##############################################################
    ...
    outfile = open("PredictionInfo","w")
    print(X_TFIDF_test)
    #for i in LR_hold_TFIDF_pred:
    #     print(i)
...
def Main(nARF):
    print(nARF)
    PeakLabel,PeakSeq = Bringfiles(DataPath+"ZmARF"+nARF+"_Soybean_bin100_Peak.fa")
    print("Peak: "+str(len(PeakLabel)))
    NonPeakLabel,NonPeakSeq = Bringfiles(DataPath+"ZmARF"+nARF+"_Soybean_bin100_NonPeak.fa")
    print("Non Peak: "+str(len(NonPeakLabel)))
    BorderLabel,BorderSeq = Bringfiles(DataPath+"ZmARF"+nARF+"_Soybean_bin100_Border.fa")
...
DataPath = "/scratch/sb14489/1-2.ML_NewTry/1-2.MakeFASTA_Soybean/2.OutputFile/"
