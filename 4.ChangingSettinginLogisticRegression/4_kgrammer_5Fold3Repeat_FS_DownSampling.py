...
def Main(nARF):
    ...
    FPR_re = []
    FNR_re = []
    #outfile = open("4.FS_Down_withAllSimulatedData.txt","w")
    for x in range(0,3):
    ...
    #print(Line)
    #outfile.write("Natural language Processing+Logistic regression+FeatureSelection+DownSampling\t"+WriteMeanSD(ACC_re)+"\t"+WriteMeanSD(FPR_re)+"\t"+WriteMeanSD(FNR_re)+"\n")
    #outfile.close()
    print("At the end")
