...
def worker(x,index,i,*args):
    ...
    #Example data
    NonPeakLabel,NonPeakSeq = Bringfiles(DataPath+"ARFSimulated_bin"+str(i)+"_NonPeakRemoveR.fa")
    BorderLabel,BorderSeq = Bringfiles(DataPath+"ARFSimulated_bin"+str(i)+"_Border.fa")	
    ...
    Line1 = "Natural language Processing +Logistic regression\t"+WriteMeanSD(Acc_re)+"\t"+WriteMeanSD(FPR_re)+"\t"+WriteMeanSD(FNR_re)+"\n"
