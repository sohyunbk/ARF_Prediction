...
#########################################################
        ...
        #print("Index of nonpeak among train")
        #print(Index_zero)  
        #print("Index of peak among train")
        #print(Index_one)
...
def Main(nARF):
    ...
    FPR_re = []
    FNR_re = []
    #outfile = open("5.FS_Up_withAllSimulatedData_BU.txt","w")
    ...
    #print(Line)
    outfile.write("Natural language Processing+Logistic regression+FeatureSelection+UpSampling\t"+WriteMeanSD(ACC_re)+"\t"+WriteMeanSD(FPR_re)+"\t"+WriteMeanSD(FNR_re)+"\n")
    outfile.close()
    print("At the end")
