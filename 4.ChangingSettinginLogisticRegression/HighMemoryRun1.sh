...
#SBATCH --output=./log/1_Kmer.%j.out   # Standard output log
#SBATCH --error=./log/1_Kmer.%j.err    # Standard error log
...
#python 1_Check_KSize_Again.py Test2
python 1_Check_KSize_Again.py Simulated
