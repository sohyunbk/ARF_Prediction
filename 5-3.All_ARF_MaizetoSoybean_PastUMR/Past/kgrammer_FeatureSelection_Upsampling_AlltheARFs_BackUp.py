...
def Main(nARF):
    ...
    PeakLabel_v,PeakSeq_v = Bringfiles(DataPath+"ZmARF"+nARF+"_Soybean_bin100_Peak.fa")
    print("Peak: "+str(len(PeakLabel)))
    NonPeakLabel_v,NonPeakSeq_v = Bringfiles(DataPath+"ZmARF"+nARF+"_Soybean_bin100_NonPeak.fa")
    print("Non Peak: "+str(len(NonPeakLabel)))
    BorderLabel_v,BorderSeq_v = Bringfiles(DataPath+"ZmARF"+nARF+"_Soybean_bin100_Border.fa")
    print("Non Peak: "+str(len(BorderLabel)))
