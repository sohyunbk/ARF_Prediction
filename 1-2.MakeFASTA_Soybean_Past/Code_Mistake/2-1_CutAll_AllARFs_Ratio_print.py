...
pwd_IF ="/scratch/sb14489/1-2.ML_NewTry/1-2.MakeFASTA_Soybean/1.InputFile/"
pwd_OF = "/scratch/sb14489/1-2.ML_NewTry/1-2.MakeFASTA_Soybean/2.OutputFile/"

ARFNumbList = ["18","25","27","29","34","35","36","39"]

for i in ARFNumbList:
	Main("ZmARF"+i+"_Soybean.GEM_events.narrowPeak",100)
