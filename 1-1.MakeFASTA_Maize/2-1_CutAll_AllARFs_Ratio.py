...
pwd_IF ="/scratch/sb14489/1.ML_DAPSeq/13.AllCombi/1.MakeFASTA/1.InputFile/"
pwd_OF = "/scratch/sb14489/1.ML_DAPSeq/13.AllCombi/1.MakeFASTA/2.Output/"

#ARFNumbList = ["10","13","14","16","18","25","27","29","34","35","36","39","4"]
ARFNumbList =["7"]
#CutList = [50,75,100,125,150,200]
#CutList = [175]

for i in ARFNumbList:
	Main("ARF"+i+".GEM_events.narrowPeak",125)
