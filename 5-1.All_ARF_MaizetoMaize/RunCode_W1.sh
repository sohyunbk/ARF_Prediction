...
#SBATCH --output=W1_RunScript.%j.out   # Standard output log
#SBATCH --error=W1_RunScript.%j.err    # Standard error log
...
python kgrammer_FeatureSelection_Upsampling_AlltheARFs_Final_5Fold3Repeat_Test.py "${List[SLURM_ARRAY_TASK_ID]}"
