...
#SBATCH --output=W2_RunScript.%j.out   # Standard output log
#SBATCH --error=W2_RunScript.%j.err    # Standard error log
...
python kgrammer_FeatureSelection_Upsampling_AlltheARFs_Final_5Fold3Repeat_Test2.py "${List[SLURM_ARRAY_TASK_ID]}"
